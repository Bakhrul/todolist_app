...
class ManageDeleteProject extends StatefulWidget {
  ManageDeleteProject({Key key, this.title, this.idproject, this.namaproject})
      : super(key: key);
  final String title, namaproject;
  final int idproject;
  @override
  State<StatefulWidget> createState() {
    return _ManageDeleteProjectState();
  }
}

class _ManageDeleteProjectState extends State<ManageDeleteProject> {
  ...
  void deleteProject() async {
    try {
      ...
      final deleteProjectUrl = await http.post(url('api/delete_project'),
          headers: requestHeaders,
          body: {'project': widget.idproject.toString()});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: new Text(
          "Hapus Project ${widget.namaproject}",
          style: TextStyle(
            color: Colors.white,
            fontSize: 14,
          ),
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  'Menghapus Project ${widget.namaproject} ?',
